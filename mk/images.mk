...
GRUB_EFI_DIR ?= $(LEONOS_SRC)/boot/grub_modules_x86_64-efi
...
$(ESP_STAMP): $(LOADER_ELF) $(O_GENERATED)/system/kernel.sys $(GRUB_FONT) $(IMAGE_DISPLAY) $(LEONOS_SRC)/tools/build/efi-stage.sh $(LEONOS_SRC)/boot/grub/embedded.cfg $(LEONOS_SRC)/boot/grub/grub.cfg $(LEONOS_SRC)/boot/grub/theme/theme.txt $(GRUB_EFI_INPUTS) $(O_META)/images.sig
