...
void draw_browser_devtools(void)
{
    ...
    pos = 0;
    line[0] = 0;
    append_text(line, &pos, sizeof(line), T("Location: "));
    ...
    pos = 0;
    line[0] = 0;
    append_text(line, &pos, sizeof(line), T("Document: "));
    ...
    if (source_truncated) {
        append_text(line, &pos, sizeof(line), T(" source limit reached"));
    }
    ...
    pos = 0;
    line[0] = 0;
    append_text(line, &pos, sizeof(line), T("Viewport: "));
    ...
    append_text(line, &pos, sizeof(line), T("; content: "));
    ...
    pos = 0;
    line[0] = 0;
    append_text(line, &pos, sizeof(line), T("Rendered: "));
    append_u32(line, &pos, sizeof(line), line_count);
    append_text(line, &pos, sizeof(line), T(" lines, "));
    append_u32(line, &pos, sizeof(line), link_count);
    append_text(line, &pos, sizeof(line), T(" links, "));
    append_u32(line, &pos, sizeof(line), browser_form_count);
    append_text(line, &pos, sizeof(line), T(" forms, "));
    append_u32(line, &pos, sizeof(line), browser_form_control_count);
    append_text(line, &pos, sizeof(line), T(" controls"));
    leonos_ui_text_clipped(&ui, 16, y + 80U, width > 20U ? width - 20U : width,
                           line, BROWSER_TEXT_DARK, LEONOS_UI_WHITE);

    pos = 0;
    line[0] = 0;
    append_text(line, &pos, sizeof(line), T("Scroll: line "));
    ...
    append_text(line, &pos, sizeof(line), T("; status: "));
...
void draw_browser(void)
{
    ...
    if (browser_embedded) {
        ...
        draw_toolbar_button(BROWSER_BACK_X, BROWSER_BACK_W, T("Back"), !can_back);
        draw_toolbar_button(toolbar_forward_x(), BROWSER_FORWARD_W, T("Forward"), !can_forward);
        draw_toolbar_button(toolbar_refresh_x(), BROWSER_REFRESH_W, T("Refresh"), 0);
    ...
    leonos_ui_text(&ui, 12, address_y() + 5U, T("Address"),
