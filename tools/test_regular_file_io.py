...
with tempfile.TemporaryDirectory(prefix="regular-file-io-") as directory:
    ...
    subprocess.run(["clang", "-std=c11", "-O1", "-g", "-fsanitize=address,undefined",
                    "-fno-sanitize-recover=all", "-Ikernel/ntclks/include", "-Iinclude", "-Ikernel/ntclks/include/uapi",
                    "-Ikernel/ntclks/kernel/ntclks/include", "tools/tests/regular_file_io_test.c",
